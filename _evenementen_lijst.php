                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">   
                            ...
                            <a href="http://localhost/nathaliejochems/index.php?link=overmij" target="_parent "class="nav-link">Terug naar de website >></a>
                                ...
                                <div class="row mt-4">
                                    <h3>Evenementenlijst tonen</h3>
                                
                                    <!--?php include('evenementen_lijst.inc.php'); ?-->
                                    ...
                                    <?php
                                        ...
                                        echo' 
                                            <div class="col-md-9">
                                              ...
                                              ?>
                                            <!--<button onclick="window.location.href='evenementAanpassen.php?id=' + 
                                            <?php echo $id  +'">Evenement aanpassen</button>-->
